...
public interface CandidateLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.adj.demo.service.impl.CandidateLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the candidate local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CandidateLocalServiceUtil} if injection and service tracking are not available.
	 */
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Candidate deleteCandidate(long candidateId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Candidate> getCandidatesByUuidAndCompanyId(
	...
	public Candidate saveCandidate(
		Map<String, Serializable> candidateMap, ServiceContext serviceContext);
	...
	public Candidate updateStatus(
		long userId, long classPK, int status, ServiceContext serviceContext,
