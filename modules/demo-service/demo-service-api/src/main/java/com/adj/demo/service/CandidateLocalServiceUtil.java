 ...
 * <code>com.adj.demo.service.impl.CandidateLocalServiceImpl</code> and
...
public class CandidateLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.adj.demo.service.impl.CandidateLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Candidate createCandidate(long candidateId) {
	 ...
	 */
	public static Candidate deleteCandidate(Candidate candidate) {
	 ...
	 */
	public static Candidate deleteCandidate(long candidateId)
		throws PortalException {
	...
	public static Candidate fetchCandidate(long candidateId) {
	 ...
	 */
	public static Candidate fetchCandidateByUuidAndGroupId(
	 ...
	 */
	public static Candidate getCandidateByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {
	 ...
	 */
	public static List<Candidate> getCandidates(int start, int end) {
	 ...
	 */
	public static List<Candidate> getCandidatesByUuidAndCompanyId(
	...
	public static List<Candidate> getCandidatesByUuidAndCompanyId(
		...
		return getService().getCandidatesByUuidAndCompanyId(
	...
	public static Candidate saveCandidate(
		Map<String, Serializable> candidateMap,
		com.liferay.portal.kernel.service.ServiceContext serviceContext) {

		return getService().saveCandidate(candidateMap, serviceContext);
	}
	 ...
	 */
	public static Candidate updateCandidate(Candidate candidate) {
		return getService().updateCandidate(candidate);
	}

	public static Candidate updateStatus(
	...
	private static volatile CandidateLocalService _service;
