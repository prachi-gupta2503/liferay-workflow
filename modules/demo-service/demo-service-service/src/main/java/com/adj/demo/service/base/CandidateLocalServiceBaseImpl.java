...
import com.adj.demo.service.CandidateLocalServiceUtil;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.adj.demo.service.impl.CandidateLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.adj.demo.service.impl.CandidateLocalServiceImpl
 * @generated
 */
public abstract class CandidateLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, CandidateLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CandidateLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>CandidateLocalServiceUtil</code>.
	 */
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return candidatePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Candidate.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return candidatePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return candidatePersistence.countWithDynamicQuery(
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return candidatePersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement CandidateLocalServiceImpl#deleteCandidate(Candidate) to avoid orphaned data");
		}
	...
	@Override
	public BasePersistence<Candidate> getBasePersistence() {
	...
	public List<Candidate> getCandidatesByUuidAndCompanyId(
		...
		return candidatePersistence.findByUuid_C(
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CandidateLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		candidateLocalService = (CandidateLocalService)aopProxy;

		_setLocalServiceUtilService(candidateLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = CandidateLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, candidateLocalService);
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CandidateLocalServiceBaseImpl.class);
