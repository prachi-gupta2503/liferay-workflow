...
public interface ProductLocalService
	...
	public Product addProduct(
		ServiceContext serviceContext, String name, long workflowId);
	...
	public Product updateStatus(
		long userId, long productId, int status, ServiceContext serviceContext);
