...
import com.adj.project.management.exception.NoSuchProductException;
...
public interface ProductPersistence extends BasePersistence<Product> {
	 ...
	 * @return the matching products
	 */
	public java.util.List<Product> findBystatus(long groupId, int status);
	 ...
	 * @return the range of matching products
	 */
	public java.util.List<Product> findBystatus(
	 ...
	 * @throws NoSuchProductException if a matching product could not be found
	 */
	public Product findBystatus_First(
	 ...
	 * @return the first matching product, or <code>null</code> if a matching product could not be found
	 */
	public Product fetchBystatus_First(
		long groupId, int status,
		com.liferay.portal.kernel.util.OrderByComparator<Product>
			orderByComparator);
	 ...
	 * @throws NoSuchProductException if a matching product could not be found
	 */
	public Product findBystatus_Last(
			long groupId, int status,
			com.liferay.portal.kernel.util.OrderByComparator<Product>
				orderByComparator)
		throws NoSuchProductException;
	 ...
	 * @return the last matching product, or <code>null</code> if a matching product could not be found
	 */
	public Product fetchBystatus_Last(
		long groupId, int status,
		com.liferay.portal.kernel.util.OrderByComparator<Product>
			orderByComparator);
	 ...
	 * @throws NoSuchProductException if a product with the primary key could not be found
	 */
	public Product[] findBystatus_PrevAndNext(
	 ...
	 * @return the range of matching products
	 */
	public java.util.List<Product> findByName(String name, int start, int end);
	 ...
	 * @return the ordered range of matching products
	 */
	public java.util.List<Product> findByName(
	 ...
	 * @throws NoSuchProductException if a matching product could not be found
	 */
	public Product findByName_First(
			String name,
			com.liferay.portal.kernel.util.OrderByComparator<Product>
				orderByComparator)
		throws NoSuchProductException;
	 ...
	 * @return the first matching product, or <code>null</code> if a matching product could not be found
	 */
	public Product fetchByName_First(
		String name,
		com.liferay.portal.kernel.util.OrderByComparator<Product>
			orderByComparator);
	 ...
	 * @throws NoSuchProductException if a matching product could not be found
	 */
	public Product findByName_Last(
			String name,
			com.liferay.portal.kernel.util.OrderByComparator<Product>
				orderByComparator)
		throws NoSuchProductException;
	 ...
	 * @return the last matching product, or <code>null</code> if a matching product could not be found
	 */
	public Product fetchByName_Last(
		String name,
		com.liferay.portal.kernel.util.OrderByComparator<Product>
			orderByComparator);
	 ...
	 * @throws NoSuchProductException if a product with the primary key could not be found
	 */
	public Product[] findByName_PrevAndNext(
