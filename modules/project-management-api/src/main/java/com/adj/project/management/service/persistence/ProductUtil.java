...
public class ProductUtil {
	...
	public static Product findByUuid_First(
		...
		throws com.adj.project.management.exception.NoSuchProductException {
	 ...
	 * @return the matching products
	 */
	public static List<Product> findBystatus(long groupId, int status) {
	 ...
	 * @return the range of matching products
	 */
	public static List<Product> findBystatus(
	 ...
	 * @throws NoSuchProductException if a matching product could not be found
	 */
	public static Product findBystatus_First(
	 ...
	 * @return the first matching product, or <code>null</code> if a matching product could not be found
	 */
	public static Product fetchBystatus_First(
		long groupId, int status,
		OrderByComparator<Product> orderByComparator) {
	 ...
	 * @throws NoSuchProductException if a matching product could not be found
	 */
	public static Product findBystatus_Last(
			long groupId, int status,
			OrderByComparator<Product> orderByComparator)
		throws com.adj.project.management.exception.NoSuchProductException {
	 ...
	 * @return the last matching product, or <code>null</code> if a matching product could not be found
	 */
	public static Product fetchBystatus_Last(
		long groupId, int status,
		OrderByComparator<Product> orderByComparator) {
	 ...
	 * @throws NoSuchProductException if a product with the primary key could not be found
	 */
	public static Product[] findBystatus_PrevAndNext(
	 ...
	 * @return the range of matching products
	 */
	public static List<Product> findByName(String name, int start, int end) {
	 ...
	 * @return the ordered range of matching products
	 */
	public static List<Product> findByName(
	 ...
	 * @throws NoSuchProductException if a matching product could not be found
	 */
	public static Product findByName_First(
	 ...
	 * @return the first matching product, or <code>null</code> if a matching product could not be found
	 */
	public static Product fetchByName_First(
		String name, OrderByComparator<Product> orderByComparator) {
	 ...
	 * @throws NoSuchProductException if a matching product could not be found
	 */
	public static Product findByName_Last(
			String name, OrderByComparator<Product> orderByComparator)
		throws com.adj.project.management.exception.NoSuchProductException {
	 ...
	 * @return the last matching product, or <code>null</code> if a matching product could not be found
	 */
	public static Product fetchByName_Last(
		String name, OrderByComparator<Product> orderByComparator) {
	 ...
	 * @throws NoSuchProductException if a product with the primary key could not be found
	 */
	public static Product[] findByName_PrevAndNext(
