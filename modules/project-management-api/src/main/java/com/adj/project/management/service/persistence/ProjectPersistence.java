...
public interface ProjectPersistence extends BasePersistence<Project> {
	 ...
	 * @return the matching projects
	 */
	public java.util.List<Project> findBystatus(long groupId, int status);
	 ...
	 * @return the range of matching projects
	 */
	public java.util.List<Project> findBystatus(
	 ...
	 * @return the matching projects
	 */
	public java.util.List<Project> findByName(String name);
	 ...
	 * @return the range of matching projects
	 */
	public java.util.List<Project> findByName(String name, int start, int end);
	 ...
	 * @return the ordered range of matching projects
	 */
	public java.util.List<Project> findByName(
