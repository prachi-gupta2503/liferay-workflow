...
package com.adj.project.management.service.persistence.impl;

import com.adj.project.management.exception.NoSuchProjectException;
import com.adj.project.management.model.Project;
import com.adj.project.management.model.impl.ProjectImpl;
import com.adj.project.management.model.impl.ProjectModelImpl;
import com.adj.project.management.service.persistence.ProjectPersistence;
import com.adj.project.management.service.persistence.impl.constants.PMPersistenceConstants;
...
public class ProjectPersistenceImpl
	 ...
	 */
	@Override
	public List<Project> findBystatus(long groupId, int status) {
		return findBystatus(
	 ...
	 */
	@Override
	public Project findBystatus_First(
			long groupId, int status,
			OrderByComparator<Project> orderByComparator)
		throws NoSuchProjectException {

		Project project = fetchBystatus_First(
	 ...
	 */
	@Override
	public Project fetchBystatus_First(
		long groupId, int status,
		OrderByComparator<Project> orderByComparator) {

		List<Project> list = findBystatus(
	 ...
	 */
	@Override
	public Project findBystatus_Last(
			long groupId, int status,
			OrderByComparator<Project> orderByComparator)
		throws NoSuchProjectException {

		Project project = fetchBystatus_Last(
			groupId, status, orderByComparator);
	 ...
	 */
	@Override
	public Project fetchBystatus_Last(
		long groupId, int status,
		OrderByComparator<Project> orderByComparator) {
	 ...
	 */
	@Override
	public Project[] findBystatus_PrevAndNext(
			long projectId, long groupId, int status,
			OrderByComparator<Project> orderByComparator)
		throws NoSuchProjectException {
		...
		try {
			...
			array[0] = getBystatus_PrevAndNext(
				session, project, groupId, status, orderByComparator, true);

			array[1] = project;

			array[2] = getBystatus_PrevAndNext(
				session, project, groupId, status, orderByComparator, false);
	...
	protected Project getBystatus_PrevAndNext(
		Session session, Project project, long groupId, int status,
		OrderByComparator<Project> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public Project findByName_First(
			String name, OrderByComparator<Project> orderByComparator)
		throws NoSuchProjectException {
	 ...
	 */
	@Override
	public Project fetchByName_First(
		String name, OrderByComparator<Project> orderByComparator) {
	 ...
	 */
	@Override
	public Project findByName_Last(
			String name, OrderByComparator<Project> orderByComparator)
		throws NoSuchProjectException {
	 ...
	 */
	@Override
	public Project fetchByName_Last(
		String name, OrderByComparator<Project> orderByComparator) {
	 ...
	 */
	@Override
	public Project[] findByName_PrevAndNext(
		...
		try {
			...
			array[0] = getByName_PrevAndNext(
				session, project, name, orderByComparator, true);

			array[1] = project;

			array[2] = getByName_PrevAndNext(
				session, project, name, orderByComparator, false);
	...
	protected Project getByName_PrevAndNext(
		Session session, Project project, String name,
		OrderByComparator<Project> orderByComparator, boolean previous) {
	...
	public void clearCache(Project project) {
		entityCache.removeResult(ProjectImpl.class, project.getPrimaryKey());
	...
	public Project updateImpl(Project project) {
		...
		if (isNew) {
			...
			args = new Object[] {
				projectModelImpl.getGroupId(), projectModelImpl.getStatus()
			};
	...
	public void activate() {
		_finderPathWithPaginationFindAll = new FinderPath(
			ProjectImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findAll", new String[0]);

		_finderPathWithoutPaginationFindAll = new FinderPath(
			ProjectImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findAll", new String[0]);
		...
		_finderPathFetchByUUID_G = new FinderPath(
			ProjectImpl.class, FINDER_CLASS_NAME_ENTITY, "fetchByUUID_G",
	...
	@Override
	@Reference(
		target = PMPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = PMPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
	...
	static {
		try {
			Class.forName(PMPersistenceConstants.class.getName());
		}
